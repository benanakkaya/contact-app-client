...
import { getLoggedUserData, setLogged, setModalVisibility } from '../redux/Users/userSlice';
...
const Homepage = () => {
    ...
    const { logged, loggedUser } = useSelector((state) => state.user);
            ...
            {logged === true &&
                <div className='flex flex-col gap-5'>
                    <div className='flex items-end justify-between h-16 border-b-2 border-lightBlue'>
                        ...
                        <input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} type="text" className='px-2 py-1 w-32 md:w-auto text-xs md:text-sm mb-1 rounded-md text-primary' placeholder={`Search a ${activeTab === "contacts" ? "contact": "group"}...`} />
                    </div>
